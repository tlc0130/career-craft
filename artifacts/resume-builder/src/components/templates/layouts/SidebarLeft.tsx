...
export default function SidebarLeft({ data, theme }: TemplateProps) {
    ...
    <div style={containerStyle}>
      ...
      <div style={sidebarStyle}>
        ...
        <div style={{ marginBottom: '24px' }}>
          <h1 style={{ fontSize: '16pt', fontWeight: 700, color: theme.accentFg, margin: '0 0 4px 0', lineHeight: 1.2, wordBreak: 'break-word' }}>
            {fullName || 'Your Name'}
          </h1>
          {contact.title && (
            <p style={{ fontSize: '9pt', color: `${theme.accentFg}cc`, margin: 0, lineHeight: 1.3 }}>
              {contact.title}
            </p>
          )}
        </div>
        ...
        {/* Contact */}
        <div>
          <h2 style={{ ...sidebarHeadingStyle, marginTop: 0 }}>Contact</h2>
          {contact.email && (
            <p style={{ fontSize: '8.5pt', color: theme.accentFg, margin: '0 0 5px 0', wordBreak: 'break-all', lineHeight: 1.3 }}>{contact.email}</p>
          )}
          {contact.phone && (
